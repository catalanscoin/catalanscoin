...
// Copyright (c) 2019, The CatalansCoin Developers
//
...
const uint64_t DIFFICULTY_TARGET                             = 210; // seconds per evitar networkforks

const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 500000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1515348;
...
For example:
CatalansCoind --print-genesis-tx --genesis-block-reward-address catv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in CatalansCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1553633624;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 63000;
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 88600;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 115000;

/* The mixin to use by default with zedwallet and catalans-service */
...
/* The index in the FORK_HEIGHTS array that this version of the software will
   ...
   software will support the fork at 15,000 blocks.
...
const char     CRYPTONOTE_NAME[]                             = "CatalansCoin";
...
const int      P2P_DEFAULT_PORT                              =  24105;
const int      RPC_DEFAULT_PORT                              =  24106;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.catalanscoin.com";
const std::string LICENSE_URL                                = "https://github.com/catalanscoin/catalanscoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xc8, 0x3c, 0xfe, 0xaa, 0xf7, 0xc2, 0xdb, 0xd3, 0xac, 0x77, 0x5b, 0x73, 0xed, 0xf7, 0x3c, 0x10  }
};

const char* const SEED_NODES[] = {
  "157.230.117.215:24105",//peer1
  "134.209.148.65:24105",//peer2
  "167.86.97.208:24105",//cryptonote.club
  "167.86.93.174:24105",
  "31.211.106.91:24105",
